// src/routes/affiliations.route.js
...
/**
 * GET /affiliations/my
 * Employee-only: list affiliations (companies) for the authenticated employee
 * Query: page, limit
 */
router.get('/my', verifyToken, async (req, res) => {
  try {
    ...
    console.error('Get my affiliations error:', err);
    return res.status(500).json({ message: 'Failed to fetch affiliations', error: err.message });
  }
});
